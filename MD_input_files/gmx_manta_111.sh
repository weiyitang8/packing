...
gmx mdrun -deffnm nvt -s nvt.tpr -v      -gputasks 111  -pin auto   -nt 6  -ntmpi 3 -nb gpu -bonded gpu -pme gpu -npme 1 -nstlist 200

gmx grompp -f equilibrationNPT.mdp -c nvt.gro -r em.gro -p topol.top -o npt.tpr -n index.ndx
gmx mdrun -deffnm npt -s npt.tpr -v      -gputasks 111  -pin auto   -nt 6  -ntmpi 3 -nb gpu -bonded gpu -pme gpu -npme 1 -nstlist 200

gmx grompp -f production.mdp -c npt.gro -p topol.top -o prod.tpr -n index.ndx
gmx mdrun -deffnm prod -s prod.tpr  -v     -gputasks 111  -pin auto   -nt 6  -ntmpi 3 -nb gpu -bonded gpu -pme gpu -npme 1 -nstlist 200 #200ns first then 400ns or 500ns
...
gmx mdrun -v -deffnm prod -s prod.tpr -cpi prod.cpt  -gputasks 111  -pin auto   -nt 6  -ntmpi 3 -nb gpu -bonded gpu -pme gpu -npme 1 -nstlist 200 #extend 200ns
