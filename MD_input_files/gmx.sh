...
gmx mdrun -deffnm nvt -s nvt.tpr -v      -nt 24 -ntmpi 4 -nb gpu -bonded cpu -pme gpu -npme 1 -nstlist 200

gmx grompp -f equilibrationNPT.mdp -c nvt.gro -r em.gro -p topol.top -o npt.tpr -n index.ndx
gmx mdrun -deffnm npt -s npt.tpr -v     -nt 24 -ntmpi 4 -nb gpu -bonded cpu -pme gpu -npme 1 -nstlist 200

gmx grompp -f production.mdp -c npt.gro -p topol.top -o prod.tpr -n index.ndx
gmx mdrun -deffnm prod -s prod.tpr  -v    -nt 24 -ntmpi 4 -nb gpu -bonded cpu -pme gpu -npme 1 -nstlist 200 #200ns first then 400ns or 500ns
...
gmx mdrun -v -deffnm prod -s prod.tpr -cpi prod.cpt -nt 24 -ntmpi 4 -nb gpu -bonded cpu -pme gpu -npme 1 -nstlist 200 #extend 200ns
